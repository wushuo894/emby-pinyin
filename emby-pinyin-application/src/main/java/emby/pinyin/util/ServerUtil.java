...
import emby.pinyin.action.BaseAction;
import emby.pinyin.action.RootAction;
import emby.pinyin.annotation.Path;
import emby.pinyin.entity.Config;
import emby.pinyin.entity.Result;
...
public class ServerUtil {
    ...
    public static SimpleServer create(String... args) {
        ...
        Set<Class<?>> classes = ClassUtil.scanPackage("emby.pinyin.action");
